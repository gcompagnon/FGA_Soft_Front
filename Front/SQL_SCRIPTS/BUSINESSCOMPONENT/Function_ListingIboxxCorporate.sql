...
-- COMPOSITION DE L INDICE IBOXX CORPORATE
-- pour etre utiliser dans les feuilles excel de Prime obligation

IF OBJECT_ID(N'ref_holding.INDEX_LISTING_CORPORATE', N'TF') IS NOT NULL
    DROP FUNCTION ref_holding.INDEX_LISTING_CORPORATE;
GO

CREATE FUNCTION ref_holding.INDEX_LISTING_CORPORATE (@dateIndex datetime)
RETURNS @Listing_Corp TABLE 
(
...
AS BEGIN
	...
	insert into @ListIndex values ( 'DE0006301161')--	iBoxx EUR Corporates
