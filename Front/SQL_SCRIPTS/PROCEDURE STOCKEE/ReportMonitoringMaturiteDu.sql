...
/****** Object:  StoredProcedure [dbo].[ReportMonitoringMaturiteDu]    Script Date: 09/18/2012 10:09:00 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[ReportMonitoringMaturiteDu] 
...
BEGIN
  set @cleReport = 'MonitoringMaturiteDu'
END
...
SELECT @cleReport as cle,
	...
	FROM #groupe_maturite as gm
	join #duration as d
		ON d.groupe=gm.groupe AND d.maturite = gm.maturite
	join #encours as e
