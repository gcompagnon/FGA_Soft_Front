...
/****** Object:  StoredProcedure [dbo].[ReportMonitoringRatingVN]    Script Date: 09/18/2012 10:10:28 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[ReportMonitoringRatingVN] 
...
BEGIN
  set @cleReport = 'MonitoringRatingVN'
END
...
SELECT @cleReport as cle,
		...
		r.ordreGroupe,
		@dateInventaire as dateInventaire,
		'VNC - Total' as rubrique,
		'VNC - Total' as libelle,
