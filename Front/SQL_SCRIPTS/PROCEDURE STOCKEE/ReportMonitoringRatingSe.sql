...
/****** Object:  StoredProcedure [dbo].[ReportMonitoringRatingSe]    Script Date: 09/18/2012 10:10:18 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[ReportMonitoringRatingSe] 
...
BEGIN
  set @cleReport = 'MonitoringRatingSe'
END
...
create table #sensibilite(groupe varchar (25) COLLATE DATABASE_DEFAULT, rating varchar(15) COLLATE DATABASE_DEFAULT, sensi float)
...
SELECT @cleReport as cle,
	...
	join #sensibilite as s
		ON s.groupe=gm.groupe AND s.rating = gm.rating
	join #encours as e
