...
/****** Object:  StoredProcedure [dbo].[ReportMonitoringGroupeSe]    Script Date: 09/18/2012 10:08:30 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[ReportMonitoringGroupeSe] 
...
BEGIN
  set @cleReport = 'MonitoringGroupeSe'
END
...
/************************************************************************/
 create table #sensi(groupe varchar (25) COLLATE DATABASE_DEFAULT ,ordreGroupe tinyint,rubrique varchar(120) COLLATE DATABASE_DEFAULT ,
...
insert 
  ...
  left outer join #sensi as rapport 
 ...
 insert 
  ...
  update rapportZone1
   set valeur = rapportZone1.valeur - rapportZone2.valeur
    from #sensi  as rapportZone1 
   left outer join #sensi  as rapportZone2 
...
/**********************************************/
  ...
  select gr.groupe as groupe,
		 ...
		 rapport.ordre,
         SUM( rapport.valeur ) as valeur
  from #GroupeCalcule as gr, #sensi as rapport 
