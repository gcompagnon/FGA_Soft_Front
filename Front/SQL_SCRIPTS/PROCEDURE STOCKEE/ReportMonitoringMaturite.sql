...
/****** Object:  StoredProcedure [dbo].[ReportMonitoringMaturite]    Script Date: 09/18/2012 10:08:51 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[ReportMonitoringMaturite] 
...
BEGIN
  set @cleReport = 'MonitoringMaturite'
END
...
create table #res ( cle char(20) COLLATE DATABASE_DEFAULT, groupe varchar(25) COLLATE DATABASE_DEFAULT, ordreGroupe tinyint, dateInventaire dateTime,  rubrique varchar(25), libelle varchar(25) COLLATE DATABASE_DEFAULT, classementRubrique tinyint, valeur float)
insert into #res
