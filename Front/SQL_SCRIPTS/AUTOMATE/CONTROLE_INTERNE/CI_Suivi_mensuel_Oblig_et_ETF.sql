--controle interne: suivi mensuel des oblig et tracker
-- entre 2 dates: par défaut, entre le 1er jour du mois présent et le dernier jour du mois 
...
and 
    O._dateoperation between @date1 and @date2 and (left(P._codedutype,1) in ('O','B') or P._tracker=1 and S._libellesecteur='FONDS OBLIGATIONS' or P._codedutype='CD'))   
