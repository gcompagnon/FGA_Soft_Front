...
case when gr0.classementRubrique=1 then ''
  ...
  left outer join [PTF_RAPPORT] as gr21_amount on gr21_amount.rubrique = gr0.rubrique
   and gr21_amount.groupe= gr21.groupe and gr21_amount.cle = @cle_Montant and gr21_amount.date = @date
  left outer join [PTF_RAPPORT] as gr21_all on gr21_all.rubrique = @rubriqueEncours
