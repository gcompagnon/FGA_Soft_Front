...
--set @rapportCle = 'MonitorExpoPaysRend'
...
case when gr0.classementRubrique=0 then ''
  ...
  gr0.rubrique,gr0.sousRubrique, gr0.libelle, 
   ...
   (gr21_amount.valeur/NULLIF(gr21_all.valeur,0)) as ' '
  from PTF_RAPPORT_NIV2 as gr0
  ...
  left outer join PTF_RAPPORT_NIV2 as gr21_amount on gr21_amount.rubrique = gr0.rubrique and gr21_amount.sousRubrique = gr0.sousRubrique 
   and gr21_amount.Groupe= gr21.Groupe and gr21_amount.cle = @cle_Montant and gr21_amount.date = @date         
  left outer join PTF_RAPPORT_NIV2 as gr21_all on gr21_all.rubrique = @rubriqueEncours and gr21_all.sousRubrique = @sousRubriqueEncours 
   and gr21_all.Groupe= gr21.Groupe and gr21_all.cle = @cle_Montant and gr21_all.date = @date      
