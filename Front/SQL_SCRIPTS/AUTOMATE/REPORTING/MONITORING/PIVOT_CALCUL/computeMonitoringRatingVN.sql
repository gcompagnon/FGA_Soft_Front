...
set @nb = (Select count(*) from PTF_RAPPORT where date = @dateInventaire and Groupe ='FGA' and cle = 'MonitoringRatingVN' )
IF @nb = 0 or ( ( @forcage <> 'N' OR @forcage <> 'n' ) and  @forcage <> '')
BEGIN
print 'MonitoringRatingVN'
execute ReportMonitoringRatingVN   @dateInventaire , 4 , 'MonitoringRatingVN'
END
