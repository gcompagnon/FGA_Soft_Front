...
set @nb = (Select count(*) from PTF_RAPPORT where date = @dateInventaire and Groupe ='FGA' and cle = 'MonitoringMaturiteVN' )
IF @nb = 0 or ( ( @forcage <> 'N' OR @forcage <> 'n' ) and  @forcage <> '')
BEGIN
print 'MonitoringMaturiteVN'
execute ReportMonitoringMaturiteVN   @dateInventaire , 4 , 'MonitoringMaturiteVN'
END
