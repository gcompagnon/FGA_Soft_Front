...
set @nb = (Select count(*) from PTF_RAPPORT where date = @dateInventaire and Groupe ='FGA' and cle = 'CompteMaturiteDu' )
IF @nb = 0 or ( ( @forcage <> 'N' OR @forcage <> 'n' ) and  @forcage <> '')
BEGIN
print 'CompteMaturiteDu'
execute ReportCompteMaturiteDu   @dateInventaire , 4 , 'CompteMaturiteDu', @comptes
END
