...
set @nb = (Select count(*) from PTF_RAPPORT_NIV2 where date = @dateInventaire and Groupe ='FGA' and cle = 'MonitorExpoPaysSe' )
IF @nb = 0 or ( ( @forcage <> 'N' OR @forcage <> 'n' ) and  @forcage <> '')
BEGIN
print 'MonitorExpoPaysSe'
execute ReportMonitoringExpositionPaysSe   @dateInventaire , 4 , 'MonitorExpoPaysSe'
END
