...
set @nb = (Select count(*) from PTF_RAPPORT where date = @dateInventaire and Groupe ='FGA' and cle = 'MonitoringRatingDu' )
IF @nb = 0 or ( ( @forcage <> 'N' OR @forcage <> 'n' ) and  @forcage <> '')
BEGIN
print 'MonitoringRatingDu'
execute ReportMonitoringRatingDu   @dateInventaire , 4 , 'MonitoringRatingDu'
END
