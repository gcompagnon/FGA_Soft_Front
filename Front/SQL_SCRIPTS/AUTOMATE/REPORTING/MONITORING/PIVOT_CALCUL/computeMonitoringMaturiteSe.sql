...
set @nb = (Select count(*) from PTF_RAPPORT where date = @dateInventaire and Groupe ='FGA' and cle = 'MonitoringMaturiteSe' )
IF @nb = 0 or ( ( @forcage <> 'N' OR @forcage <> 'n' ) and  @forcage <> '')
BEGIN
print 'MonitoringMaturiteSe'
execute ReportMonitoringMaturiteSe   @dateInventaire , 4 , 'MonitoringMaturiteSe'
END
