...
set @nb = (Select count(*) from PTF_RAPPORT where date = @dateInventaire and Groupe ='FGA' and cle = 'CompteRatingDu' )
IF @nb = 0 or ( ( @forcage <> 'N' OR @forcage <> 'n' ) and  @forcage <> '')
BEGIN
print 'CompteRatingDu'
execute ReportCompteRatingDu   @dateInventaire , 4 , 'CompteRatingDu', @comptes
END
