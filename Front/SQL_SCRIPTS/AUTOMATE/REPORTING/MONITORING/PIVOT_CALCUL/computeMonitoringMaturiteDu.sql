...
set @nb = (Select count(*) from PTF_RAPPORT where date = @dateInventaire and Groupe ='FGA' and cle = 'MonitoringMaturiteDu' )
IF @nb = 0 or ( ( @forcage <> 'N' OR @forcage <> 'n' ) and  @forcage <> '')
BEGIN
print 'MonitoringMaturiteDu'
execute ReportMonitoringMaturiteDu   @dateInventaire , 4 , 'MonitoringMaturiteDu'
END
